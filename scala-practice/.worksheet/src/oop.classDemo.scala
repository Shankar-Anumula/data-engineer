...
object classDemo {
	...
	val ep = new EmpPerson;System.out.println("""ep  : oop.classDemo.EmpPerson = """ + $show(ep ));$skip(14); ;
	println(ep);
	
	//Class Person wth 2 parameters
	class SamplePerson(val name:String,val Age:Int);$skip(141); ; //constructor
	val sp = new SamplePerson("Shankar",32);System.out.println("""sp  : oop.classDemo.SamplePerson = """ + $show(sp ));$skip(136); ;
	...
	val person = new Person("Shankar", 32);System.out.println("""person  : oop.classDemo.Person = """ + $show(person ));$skip(27); ;
